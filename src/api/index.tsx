...
export const fieldsTable: {
  ...
  { id: 1, name: "agentId", type: "TextInput", placeholder: "Enter agent id", tooltip: "Clients agent id", label: "Agent Id" },
  {
    id: 2,
    name: "location",
    type: "Select",
    ...
    tooltip: "Location",
    data: ["New York, NY 55311", "Edmond Av, Seattle WA 99120", "5012 Seminary Rd, Miami Fl 33103"],
    label: "Location"
  },
  {
    id: 3,
  ...
  { id: 4, name: "on", type: "TextInput", label: "ON" },
  {
    id: 5,
    name: "dv",
    type: "Checkbox",
...
export const formTable: {
  ...
  { id: 2, regionId: 2, locationId: 1 },
  { id: 3, regionId: 3, locationId: 1 },
  { id: 4, regionId: 4, locationId: 1 },
